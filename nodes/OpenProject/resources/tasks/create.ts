...
export async function createTask(
    ...
    const type = this.getNodeParameter('type', itemIndex, undefined, { extractValue: true  }) as string;
    ...
    const response = await openProjectRequest.call(this, 'POST', '/work_packages', {}, {
        subject,
        _links: {
